        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              />
              {/* Decorative elements */}
              <img src={decor3} alt="" className="absolute -top-10 -right-10 w-24 h-24" />
              <img src={decor2} alt="" className="absolute -bottom-10 -left-10 w-32 h-32" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              />
              {/* Decorative elements */}
              <img src={decor2} alt="" className="absolute -top-8 -left-8 w-24 h-24" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {getVisibleProducts().map((product, index) => (
                ...
                >
                  ...
                  <button className="w-full bg-[#285153] hover:bg-[#1a3839] text-white py-2 rounded-full font-semibold transition-colors">
                    add to cart
                  </button>
                </div>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              />
              {/* Decorative elements */}
              <img src={decor2} alt="" className="absolute -bottom-10 -right-10 w-28 h-28" />
            </div>
          </div>
        </div>
      </section>
